...
var LARGEST = 0;
var SOME_PERCENTAGE = 0.95;

// global variable holding forward motion vectors from previous frames
var prev_fwd_mvs = [ ];

// change tail value to use a smaller or greater number of frmes to average
...
/**
 * @param {number} percent - The percentage of fastest mvs to blur
 * @param {number} tail_length - the ammount of frames to average
 */
export function glitch_frame(frame, percent = 50, tail_length = 20)
{
